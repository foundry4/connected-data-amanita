"""Pytest Suite to test validation tools. Full coverage over validation.py through testing of process_query_params."""
import pytest

from app.utils import processquery
...
"""Test `process_query_params()` with test coverage over query parameters passed through with singular & multiple 
...
def test_process_query_params_multi_allowed(monkeypatch, mapping):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', mapping)
    validated_params = process_query_params(multi_input_query_params_multidict_allowed)
...
def test_process_query_params_multi_not_allowed(monkeypatch, param_multidict):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', get_multi_query_parameter_test_mappings_restricted())
    with pytest.raises(InvalidInputQuery):
        process_query_params(param_multidict)
...
def test_process_query_params_single_allowed(monkeypatch, mapping):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', mapping)
    validated_params = process_query_params(input_query_params_multidict_allowed)
...
def test_process_query_params_single_not_allowed(monkeypatch):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', get_multi_query_parameter_test_mappings_restricted())
    with pytest.raises(InvalidInputQuery):
        process_query_params(input_query_params_multidict_not_allowed)
...
def test_process_query_params_invalid_parameter(monkeypatch):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', get_single_query_parameter_test_mappings())
    with pytest.raises(InvalidInputQuery):
        process_query_params(invalid_input_query_params_multidict)
...
def test_process_query_params_multi_when_expect_single(monkeypatch):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', get_single_query_parameter_test_mappings())
    with pytest.raises(InvalidInputQuery):
        process_query_params(multi_input_query_params_multidict_allowed)
...
def test_process_query_params_empty(monkeypatch):
    ...
    monkeypatch.setattr(processquery, 'query_parameter_validators', get_single_query_parameter_test_mappings())
    validated_params = process_query_params(empty_input_query_params_multidict)
